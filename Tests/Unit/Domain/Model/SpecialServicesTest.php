...
/**
 * Test case for class \RKW\RkwConsultant\Domain\Model\SpecialServices.
 *
 * @copyright Copyright belongs to the respective authors
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License, version 3 or later
 *
 */
class SpecialServicesTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \RKW\RkwConsultant\Domain\Model\SpecialServices
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \RKW\RkwConsultant\Domain\Model\SpecialServices();
	}
