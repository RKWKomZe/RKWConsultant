...
/**
 * Test case for class \RKW\RkwConsultant\Domain\Model\Service.
 *
...
class ServiceTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \RKW\RkwConsultant\Domain\Model\Service
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \RKW\RkwConsultant\Domain\Model\Service();
	}
